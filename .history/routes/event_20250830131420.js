    ...
    form.parse(req, function(err, fields, files) {
        ...
        Event.findById(eventId).exec(function(err, event) {
            ...
            Sequence.findOneAndUpdate(
                ...
                // Always generate QR code and barcode values for registration
                const registrationUniqueId = fields.uniqueId || (eventId + '-' + registrationId);
                let qrCodeValue = registrationId.qrCode;
                let barcodeValue = registrationId.barcode;
                var eventData = new EventData({
