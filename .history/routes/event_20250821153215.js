        ...
        if (fs.existsSync(confirmationHtmlPath)) {
            try {
                ...
                if(registrationId) {
                    ...
                    EventData.findOne({event: eventId.toString(), registrationId: registrationId}).exec(function(err, registration) {
                        console.log('🔔 [DEBUG] Registration lookup result:', registration);
                        if(err) {
