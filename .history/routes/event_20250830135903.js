    ...
    form.parse(req, function(err, fields, files) {
        ...
        Event.findById(eventId).exec(function(err, event) {
            ...
            Sequence.findOneAndUpdate(
                ...
                let qrCodeValue = fields.qrCode && fields.qrCode.trim() !== '' ? fields.qrCode : (fields.uniqueId && fields.uniqueId.trim() !== '' ? fields.uniqueId : (eventId + '-' + registrationId));
                let barcodeValue = fields.barcode && fields.barcode.trim() !== '' ? fields.barcode : qrCodeValue;
                // Short code: last 6 digits
