...
router.post('/online-registration/:id/save-design', function(req, res) {
    ...
    Event.findById(eventId).exec(function(err, event) {
        ...
        var debugLogoUrl = (req.fields && req.fields.logoUrl) || (req.body && req.body.logoUrl);
        var debugBackgroundImage = (req.fields && req.fields.backgroundImage) || (req.body && req.body.backgroundImage);
        ...
        try {
            ...
            var logoUrl = (req.fields && typeof req.fields.logoUrl === 'string') ? req.fields.logoUrl :
                          (req.body && typeof req.body.logoUrl === 'string') ? req.body.logoUrl : '';
            var designData = {
                header: {
            ...
            var backgroundImage = (req.fields && typeof req.fields.backgroundImage === 'string') ? req.fields.backgroundImage :
                                  (req.body && typeof req.body.backgroundImage === 'string') ? req.body.backgroundImage : '';
            ...
            var canvasHtml = (req.fields && req.fields.canvasHtml) || (req.body && req.body.canvasHtml) || '';
            var updateData = {
