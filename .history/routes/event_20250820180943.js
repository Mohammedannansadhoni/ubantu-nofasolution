...
function generateCompleteRegistrationHTML(canvasHtml, event, eventId) {
    // Extract dynamic form fields from event configuration
    ...
    fieldDefinitions.forEach(function(fieldDef) {
        ...
        if(showInOnlineRegistration) {
            ...
            switch(fieldDef.type) {
                case 'email':
                    inputHtml = '<input type="email" id="' + fieldDef.name + '" name="' + fieldDef.name + '" class="form-control" ' + requiredAttr + '>';
                    break;
                case 'tel':
                    inputHtml = '<input type="tel" id="' + fieldDef.name + '" name="' + fieldDef.name + '" class="form-control" ' + requiredAttr + '>';
                    break;
                case 'url':
                    inputHtml = '<input type="url" id="' + fieldDef.name + '" name="' + fieldDef.name + '" class="form-control" ' + requiredAttr + '>';
                    break;
                case 'dropdown':
                ...
                case 'select':
                    if(fieldDef.name === 'country') {
                        inputHtml = '<select id="' + fieldDef.name + '" name="' + fieldDef.name + '" class="form-control" ' + requiredAttr + '>' +
                    ...
                    break;
                default:
                    inputHtml = '<input type="text" id="' + fieldDef.name + '" name="' + fieldDef.name + '" class="form-control" ' + requiredAttr + '>';
            }
...
canvasHtml +
'        ' +
'        <!-- Registration Form - This will be inserted into the designed canvas -->' +
'        <script>' +
'            document.addEventListener("DOMContentLoaded", function() {' +
'                // Find the canvas container and add the registration form' +
...
'                                "<form action=\\"/event/' + eventId + '/public-register\\" method=\\"POST\\" id=\\"registrationForm\\">" +' +
                                    formFieldsHtml +
...
'                        "</div>";' +
'                    ' +
'                    // Insert form into canvas content' +
'                    var canvasContent = canvasContainer.querySelector(".canvas-content");' +
'                    if (canvasContent) {' +
'                        canvasContent.innerHTML += formHtml;' +
'                    } else {' +
'                        canvasContainer.innerHTML += formHtml;' +
'                    }' +
'                }' +
'            });' +
'        </script>' +
