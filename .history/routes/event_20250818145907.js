...
router.post('/manage-fonts', function(req, res) {
    ...
    form.parse(req, function (err, fields, files) {
        ...
        Font.findOne({fontName: fontName.trim(), isActive: true}, function(err, existingFont) {
            if(existingFont) {
                return res.redirect('/event/manage-fonts');
            }
            ...
            function handleFileUpload(fileObj) {
                ...
                // Copy uploaded file to fonts directory
                fs.readFile(oldpath, function (err, data) {
                    if (err) {
                    ...
                    fs.writeFile(newpath, data, function (err) {
                        ...
                        fs.unlink(oldpath, function (unlinkErr) {
                            if (unlinkErr) console.log('Warning: Could not delete temp file');
                        });
                    });
                });
            }
            ...
            function saveFont() {
                newFont.save(function(err, savedFont) {
                    if(err) {
                        ...
                        console.log('Font saved successfully:', savedFont.fontName);
                    }
                    res.redirect('/event/manage-fonts');
                });
            }
