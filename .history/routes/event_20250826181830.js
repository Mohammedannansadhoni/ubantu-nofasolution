...
router.post('/online-registration/:id/save-design', function(req, res) {
    ...
    Event.findById(eventId).exec(function(err, event) {
        ...
        try {
            ...
            if (req.fields.logoUrl && typeof req.fields.logoUrl === 'string' && req.fields.logoUrl.startsWith('data:')) {
                designData.header.logo = saveBase64Image(req.fields.logoUrl, 'header-logo');
            } else if (req.fields.logoUrl && typeof req.fields.logoUrl === 'string') {
                designData.header.logo = req.fields.logoUrl;
            } else {
