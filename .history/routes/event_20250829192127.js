...
router.get('/badge-layout', function(req,res){
    ...
    Event.findById(eventId, function (err, event) {
        ...
        console.log('🖨️ Fields displayed in badge/print layout:', printFieldsLog);
    ...
    Event.findById(eventId).exec(function(err, event) {
        ...
        Object.keys(event.toJSON()).forEach(function(item){
            if(item.indexOf('_showInOnlineRegistration')>-1 && event[item]==true ){
                fieldIndex = fieldIndex + 1;
                var fieldName = item.substring(0, item.indexOf('_showInOnlineRegistration') );
                onlineFieldsLog.push(fieldName);
                var fieldLabel = fieldName + '_label';
                var fieldType = fieldName + '_fieldType';
                var fieldValue = '';
                var fieldMandatory = fieldName + '_isMandatory';
        ...
        console.log('🌐 Fields displayed in online registration:', onlineFieldsLog);
