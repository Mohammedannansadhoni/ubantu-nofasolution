...
router.post('/event-fields', function (req, res) {
    ...
    // Log all showInOnlineRegistration fields received in the POST body
    console.log('POST /event-fields received:');
    [
        'uniqueId_showInOnlineRegistration',
        'barcode_showInOnlineRegistration',
        'qrCode_showInOnlineRegistration',
        'uploadImage_showInOnlineRegistration',
        'uploadLogo_showInOnlineRegistration',
        'sno_showInOnlineRegistration',
        'title_showInOnlineRegistration',
        'firstName_showInOnlineRegistration',
        'middleName_showInOnlineRegistration',
        'lastName_showInOnlineRegistration',
        'fullName_showInOnlineRegistration',
        'jobTitle_showInOnlineRegistration',
        'department_showInOnlineRegistration',
        'companyName_showInOnlineRegistration',
        'mobile1_showInOnlineRegistration',
        'mobile2_showInOnlineRegistration',
        'tel1_showInOnlineRegistration',
        'tel2_showInOnlineRegistration',
        'fax_showInOnlineRegistration'
    ...
    Event.findById(eventId, function (err, event) {
        ...
        // After setting all properties, log the final showInOnlineRegistration values
        console.log('🔍 [DEBUG] showInOnlineRegistration values after save:');
        [
            'uniqueId', 'barcode', 'qrCode', 'uploadImage', 'uploadLogo', 'sno', 'title', 'firstName', 'middleName', 'lastName', 'fullName', 'jobTitle', 'department', 'companyName', 'mobile1', 'mobile2', 'tel1', 'tel2', 'fax', 'email', 'website', 'address1', 'address2', 'city', 'country', 'poBox', 'postalCode', 'badgeCategory', 'regType', 'regDate', 'badgePrintDate', 'modifiedDate', 'statusFlag', 'backoffice', 'comment1', 'comment2', 'comment3', 'comment4', 'comment5', 'comment6', 'comment7', 'comment8', 'comment9', 'comment10'
        ].forEach(function(field) {
            console.log(field + ':', event[field + '_showInOnlineRegistration']);
        });
        ...
        [
            ...
            event[field + '_showInOnlineRegistration'] = req.body[field + '_showInOnlineRegistration'] ? true : false;
        });
...
router.get('/online-registration/:id/design-registration', function(req, res) {
    ...
    Event.findById(eventId).exec(function(err, event) {
        ...
        var fields = fieldDefinitions.filter(function(fieldDef) {
            return event[fieldDef.name + '_showInOnlineRegistration'];
        });
        ...
        if(event.fieldsOrder && Array.isArray(event.fieldsOrder)) {
            ...
            event.fieldsOrder.forEach(function(orderItem) {
                var field = fields.find(f => f.name === orderItem.fieldName);
                if(field) {
