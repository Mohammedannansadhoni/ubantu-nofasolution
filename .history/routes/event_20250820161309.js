                    ...
                    if (transporter) {
                        ...
                        var mailOptions = {
                            ...
                            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                                ...
                                <p>Dear ${savedData.fullName || savedData.firstName + ' ' + savedData.lastName || 'Participant'},</p>
                                ...
                                <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                                    ...
                                    ${savedData.fullName ? `<p><strong>Name:</strong> ${savedData.fullName}</p>` : ''}
                                    ${savedData.companyName ? `<p><strong>Company:</strong> ${savedData.companyName}</p>` : ''}
                                    ${savedData.badgeCategory ? `<p><strong>Badge Type:</strong> ${savedData.badgeCategory}</p>` : ''}
                                    <p><strong>Registration Date:</strong> ${moment(savedData.regDate).format('MMMM DD, YYYY')}</p>
                                </div>
                                
                                <p style="text-align: center;">
                                    <a href="${confirmationUrl}" style="background: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block;">View Confirmation Page</a>
                                </p>
