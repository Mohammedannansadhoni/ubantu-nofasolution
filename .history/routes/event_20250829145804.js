...
router.post('/event-fields', function (req, res) {
    ...
    event.country_showInOnlineRegistration = req.body['country_showInOnlineRegistration'] ? true : false;
        ...
        // Always update showInOnlineRegistration for all fields
        [
            'uniqueId', 'barcode', 'qrCode', 'uploadImage', 'uploadLogo', 'sno', 'title',
            ...
            'regType', 'regDate', 'badgePrintDate', 'modifiedDate', 'statusFlag', 'backoffice',
